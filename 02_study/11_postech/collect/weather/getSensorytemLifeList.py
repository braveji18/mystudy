...
insertQuery = """
INSERT INTO WEATHER 
    (area_do,area_gu,area_dong,base_date, A03)
VALUES 
    (%s, %s, %s, %s, %s )
"""
...
def getSensorytemLifeList(cnx, base_time ) :
    ...
    for keys, loc_info in weather.LOCATION_INFOS.items():
        ...
        if resultMsg != '' :
            print 'Error : getSensorytemLifeList(%s) : %s'  % ( base_time,  resultMsg )  
            continue   
...
def main():
    ...
    try:
        ...
        getSensorytemLifeList(cnx, base_time )
...
if __name__ == "__main__":
    ...
    print ("getSensorytemLifeList.py, Run Time: %d sec" %(t2-t1) )