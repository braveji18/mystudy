...
insertQuery = """
INSERT INTO WEATHER 
    (area_do,area_gu,area_dong,base_date, A08)
VALUES 
    (%s, %s, %s, %s, %s )
"""
...
def getWinterLifeList(cnx, base_time ) :
    ...
    for keys, loc_info in weather.LOCATION_INFOS.items():
        ...
        if resultMsg != '' :
            print 'Error : getWinterLifeList(%s) : %s'  % ( base_time,  resultMsg )  
            continue          
...
def main():
    ...
    try:
        ...
        getWinterLifeList(cnx, base_time )
...
if __name__ == "__main__":
    ...
    print ("getWinterLifeList.py, Run Time: %d sec" %(t2-t1) )