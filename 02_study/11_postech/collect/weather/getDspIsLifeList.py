...
def getDspIsLifeList(cnx, base_time ) :
    ...
    for keys, loc_info in weather.LOCATION_INFOS.items():
        ...
        if resultMsg != '' :
            print 'Error : getDspIsLifeList(%s) : %s'  % ( base_time,  resultMsg )  
            continue          
...
def main():
    ...
    try:
        ...
        getDspIsLifeList(cnx, base_time )
...
if __name__ == "__main__":
    ...
    print ("getDspIsLifeList.py, Run Time: %d sec" %(t2-t1) )
