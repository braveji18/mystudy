...
insertQuery = """
INSERT INTO WEATHER 
    (area_do,area_gu,area_dong,base_date, A05)
VALUES 
    (%s, %s, %s, %s, %s )
"""
...
if __name__ == "__main__":
    ...
    print ("getHeatLifeList.py, Run Time: %d sec" %(t2-t1) )