...
insertQuery = """
INSERT INTO WEATHER 
    (area_do,area_gu,area_dong,base_date, A07)
VALUES 
    (%s, %s, %s, %s, %s )
"""
...
def getUltrvLifeList(cnx, base_time ) :
    ...
    for keys, loc_info in weather.LOCATION_INFOS.items():
        ...
        if resultMsg != '' :
            print 'Error : getUltrvLifeList(%s) : %s'  % ( base_time,  resultMsg )  
            continue   
        
        to_day = data['Response']['body']['indexModel']['date'] + '0000'
...
def main():
    ...
    try:
        ...
        getUltrvLifeList(cnx, base_time )
...
if __name__ == "__main__":
    ...
    print ("getUltrvLifeList.py, Run Time: %d sec" %(t2-t1) )