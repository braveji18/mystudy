// ORM class for table 'MEASURE_LOCATION'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Mon Oct 16 10:56:36 KST 2017
...
public class MEASURE_LOCATION extends SqoopRecord  implements DBWritable, Writable {
  ...
  public MEASURE_LOCATION with_sensor_name(String sensor_name) {
    this.sensor_name = sensor_name;
    return this;
  }
  ...
  public MEASURE_LOCATION with_site_name(String site_name) {
    this.site_name = site_name;
    return this;
  }
  ...
  public MEASURE_LOCATION with_site_floor(String site_floor) {
    this.site_floor = site_floor;
    return this;
  }
  ...
  public MEASURE_LOCATION with_site_area(String site_area) {
    this.site_area = site_area;
    return this;
  }
  ...
  public MEASURE_LOCATION with_base_roomtype(String base_roomtype) {
    this.base_roomtype = base_roomtype;
    return this;
  }
  ...
  public MEASURE_LOCATION with_description(String description) {
    this.description = description;
    return this;
  }
  ...
  public MEASURE_LOCATION with_reg_date(java.sql.Timestamp reg_date) {
    this.reg_date = reg_date;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof MEASURE_LOCATION)) {
      return false;
    }
    MEASURE_LOCATION that = (MEASURE_LOCATION) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.site_name = JdbcWritableBridge.readString(2, __dbResults);
    this.site_floor = JdbcWritableBridge.readString(3, __dbResults);
    this.site_area = JdbcWritableBridge.readString(4, __dbResults);
    this.base_roomtype = JdbcWritableBridge.readString(5, __dbResults);
    this.description = JdbcWritableBridge.readString(6, __dbResults);
    this.reg_date = JdbcWritableBridge.readTimestamp(7, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(site_name, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(site_floor, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(site_area, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(base_roomtype, 5 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(description, 6 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeTimestamp(reg_date, 7 + __off, 93, __dbStmt);
    return 7;
  }
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    MEASURE_LOCATION o = (MEASURE_LOCATION) super.clone();
    o.reg_date = (o.reg_date != null) ? (java.sql.Timestamp) o.reg_date.clone() : null;
    return o;
  }

  public void clone0(MEASURE_LOCATION o) throws CloneNotSupportedException {
    o.reg_date = (o.reg_date != null) ? (java.sql.Timestamp) o.reg_date.clone() : null;
  }
